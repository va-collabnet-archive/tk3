...
public class ImageRevisionTest {
    ...
    private MediaRevision testObj1;
    private MediaRevision testObj2;
    private MediaRevision testObj3;
    ...
    public void testEqualsInACollection() {
        ...
        Set<MediaRevision> coll = new java.util.HashSet<MediaRevision>();
        coll.add(testObj1);
    ...
    private MediaRevision makeTestObject1() {
        
        // Create an object to test... 
        MediaRevision obj = new MediaRevision();
    ...
    private MediaRevision makeTestObject2() {
