...
public class PositionMapper {
    ...
    public boolean idsOnRoute(IdBI idVersion) {
        queryCount++;
    ...
    public RELATIVE_POSITION fastRelativeIdPartsPosition(IdBI part1, IdBI part2, Precedence precedencePolicy) {
        queryCount++;
        lastRequestTime = System.currentTimeMillis();
        // Forms a barrier to ensure that the setup is complete prior to use
        try {
    ...
    private RELATIVE_POSITION pathBasedPolicy(IdBI part1, IdBI part2){
    ...
    private RELATIVE_POSITION timeBasedPolicy(IdBI part1, IdBI part2){
