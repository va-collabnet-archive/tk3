package org.ihtsdo.concept.component.refex.type_nid_nid_string;
...
public class NidNidStringMember extends RefexMember<NidNidStringRevision, NidNidStringMember>
   ...
   private static VersionComputer<RefexMember<NidNidStringRevision, NidNidStringMember>.Version> computer =
      new VersionComputer<RefexMember<NidNidStringRevision, NidNidStringMember>.Version>();
   ...
   public NidNidStringMember(TkRefexUuidUuidStringMember refsetMember, int enclosingConceptNid) throws IOException {
      ...
      if (refsetMember.getRevisionList() != null) {
         revisions = new RevisionSet<NidNidStringRevision, NidNidStringMember>(primordialSapNid);
   ...
   public int getTypeNid() {
      return TK_REFEX_TYPE.CID_CID_STR.getTypeToken();
   }
