...
public class NidMember extends RefexMember<NidRevision, NidMember>
   ...
   private static VersionComputer<RefexMember<NidRevision, NidMember>.Version> computer =
      new VersionComputer<RefexMember<NidRevision, NidMember>.Version>();
   ...
   public NidMember(TkRefexUuidMember refsetMember, int enclosingConceptNid) throws IOException {
      ...
      if (refsetMember.getRevisionList() != null) {
         revisions = new RevisionSet<NidRevision, NidMember>(primordialSapNid);
   ...
   public NidRevision makeAnalog() {
      NidRevision newR = new NidRevision(getStatusNid(), getAuthorNid(), getPathNid(), getTime(), this);
