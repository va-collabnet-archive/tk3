...
public abstract class AbstractUuidList extends AbstractList {
	...
	/**
	 * Sets the receiver's elements to be the specified array. The size and
	 * capacity of the list is the length of the array. <b>WARNING:</b> For
	 * efficiency reasons and to keep memory usage low, this method may decide
	 * <b>not to copy the array</b>. So if subsequently you modify the returned
	 ...
	 * public DatabaseList extends AbstractUuidList { ... public void
