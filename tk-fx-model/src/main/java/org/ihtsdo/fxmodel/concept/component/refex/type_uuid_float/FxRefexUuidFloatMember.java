...
public class FxRefexUuidFloatMember extends FxRefexAbstractMember<FxRefexUuidFloatRevision> {
   ...
   public FxRefexUuidFloatMember() {
      super();
   }

   public FxRefexUuidFloatMember(RefexChronicleBI another) throws IOException {
      ...
      if (partCount > 1) {
         ...
         while (itr.hasNext()) {
            rv = itr.next();
            revisions.add(new FxRefexUuidFloatRevision(rv));
         }
      }
   }
   //~--- methods -------------------------------------------------------------
   ...
   public boolean equals(Object obj) {
      ...
      if (FxRefexUuidFloatMember.class.isAssignableFrom(obj.getClass())) {
         FxRefexUuidFloatMember another = (FxRefexUuidFloatMember) obj;
   ...
   @Override
   public List<FxRefexUuidFloatRevision> getRevisionList() {
      return revisions;
   }

   @Override
   public List<FxRefexUuidFloatRevision> getRevisions() {
      return revisions;
   }
