...
public class FxRefexUuidUuidStringRevision extends FxRevision {
   ...
   public FxRefexUuidUuidStringRevision() {
      super();
   }

   public FxRefexUuidUuidStringRevision(RefexNidNidStringVersionBI another) throws IOException {
      super(another);
   ...
   public boolean equals(Object obj) {
      ...
      if (FxRefexUuidUuidStringRevision.class.isAssignableFrom(obj.getClass())) {
         FxRefexUuidUuidStringRevision another = (FxRefexUuidUuidStringRevision) obj;
