...
public class FxRefexBooleanRevision extends FxRevision {
  ...
  public boolean booleanValue;
   ...
   public FxRefexBooleanRevision() {
      super();
   }

   public FxRefexBooleanRevision(RefexBooleanVersionBI another) throws IOException {
      super(another);
   ...
   public boolean equals(Object obj) {
      ...
      if (FxRefexBooleanRevision.class.isAssignableFrom(obj.getClass())) {
         FxRefexBooleanRevision another = (FxRefexBooleanRevision) obj;
