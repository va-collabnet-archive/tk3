...
public class FxRefexUuidLongRevision extends FxRevision {
   ...
   public FxRefexUuidLongRevision() {
      super();
   }

   public FxRefexUuidLongRevision(RefexNidLongVersionBI another) throws IOException {
      super(another);
   ...
   public boolean equals(Object obj) {
      ...
      if (FxRefexUuidLongRevision.class.isAssignableFrom(obj.getClass())) {
         FxRefexUuidLongRevision another = (FxRefexUuidLongRevision) obj;
