...
public class FxRefexUuidUuidRevision extends FxRevision {
   ...
   public FxRefexUuidUuidRevision() {
      super();
   }

   public FxRefexUuidUuidRevision(RefexNidNidVersionBI another) throws IOException {
      super(another);
   ...
   public boolean equals(Object obj) {
      ...
      if (FxRefexUuidUuidRevision.class.isAssignableFrom(obj.getClass())) {
         FxRefexUuidUuidRevision another = (FxRefexUuidUuidRevision) obj;
