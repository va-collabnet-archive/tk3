...
public class FxDescriptionRevision extends FxRevision implements I_DescribeExternally {
   ...
   public FxDescriptionRevision() {
      super();
   }

   public FxDescriptionRevision(DescriptionVersionBI another) throws IOException {
      super(another);
   ...
   public boolean equals(Object obj) {
      ...
      if (FxDescriptionRevision.class.isAssignableFrom(obj.getClass())) {
         FxDescriptionRevision another = (FxDescriptionRevision) obj;
