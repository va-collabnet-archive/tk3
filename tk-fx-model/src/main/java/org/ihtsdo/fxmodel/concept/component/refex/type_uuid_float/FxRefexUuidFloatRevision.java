...
public class FxRefexUuidFloatRevision extends FxRevision {
   ...
   public FxRefexUuidFloatRevision() {
      super();
   }

   public FxRefexUuidFloatRevision(RefexNidFloatVersionBI another) throws IOException {
      super(another);
   ...
   public boolean equals(Object obj) {
      ...
      if (FxRefexUuidFloatRevision.class.isAssignableFrom(obj.getClass())) {
         FxRefexUuidFloatRevision another = (FxRefexUuidFloatRevision) obj;
