...
public abstract class FxRefexAbstractMember<V extends FxRevision> extends FxComponent<V> {
   ...
   public FxRefexAbstractMember() {
      super();
   }

   public FxRefexAbstractMember(RefexVersionBI another) throws IOException {
      super(another);
   ...
   public boolean equals(Object obj) {
      ...
      if (FxRefexAbstractMember.class.isAssignableFrom(obj.getClass())) {
         FxRefexAbstractMember<?> another = (FxRefexAbstractMember<?>) obj;
