package org.ihtsdo.ttk.dto.component.refex.type_uuid_uuid_uuid_float;
...
public class TkRefexUuidUuidUuidFloatMember
        extends TkRefexAbstractMember<TkRefexUuidUuidUuidFloatRevision> {
   ...
   public TkRefexUuidUuidUuidFloatMember() {
      super();
   }

   public TkRefexUuidUuidUuidFloatMember(RefexChronicleBI another)
           throws IOException {
      ...
      if (partCount > 1) {
         ...
         while (relItr.hasNext()) {
            rv = relItr.next();
            revisions.add(new TkRefexUuidUuidUuidFloatRevision(rv));
         }
      }
   }

   public TkRefexUuidUuidUuidFloatMember(DataInput in, int dataVersion)
   ...
   public TkRefexUuidUuidUuidFloatMember(
           TkRefexUuidUuidUuidFloatMember another,
   ...
   public boolean equals(Object obj) {
      ...
      if (TkRefexUuidUuidUuidFloatMember.class.isAssignableFrom(
              obj.getClass())) {
         TkRefexUuidUuidUuidFloatMember another =
            (TkRefexUuidUuidUuidFloatMember) obj;
   ...
   @Override
   public TkRefexUuidUuidUuidFloatMember makeTransform(
           ComponentTransformerBI transformer) {
      return new TkRefexUuidUuidUuidFloatMember(this, transformer);
   }
   ...
   public final void readExternal(DataInput in, int dataVersion)
      ...
      if (versionSize > 0) {
         ...
         for (int i = 0; i < versionSize; i++) {
            revisions.add(new TkRefexUuidUuidUuidFloatRevision(in,
                    dataVersion));
         }
      }
   }
   ...
   public void writeExternal(DataOutput out) throws IOException {
      ...
      if (revisions == null) {
         ...
         for (TkRefexUuidUuidUuidFloatRevision rmv : revisions) {
   ...
   @Override
   public List<TkRefexUuidUuidUuidFloatRevision> getRevisionList() {
      return revisions;
   }

   @Override
   public ToolkitRefexType getType() {
      return ToolkitRefexType.CID_CID_CID_FLOAT;
   }
