package org.ihtsdo.ttk.dto.component.refex.type_uuid_uuid_uuid_long;
...
public class TkRefexUuidUuidUuidLongMember
        extends TkRefexAbstractMember<TkRefexUuidUuidUuidLongRevision> {
   ...
   public TkRefexUuidUuidUuidLongMember() {
      super();
   }

   public TkRefexUuidUuidUuidLongMember(RefexChronicleBI another)
           throws IOException {
      ...
      if (partCount > 1) {
         ...
         while (relItr.hasNext()) {
            rv = relItr.next();
            revisions.add(new TkRefexUuidUuidUuidLongRevision(rv));
         }
      }
   }

   public TkRefexUuidUuidUuidLongMember(DataInput in, int dataVersion)
           throws IOException, ClassNotFoundException {
      super();
      readExternal(in, dataVersion);
   }

   public TkRefexUuidUuidUuidLongMember(TkRefexUuidUuidUuidLongMember another,
   ...
   public boolean equals(Object obj) {
      ...
      if (TkRefexUuidUuidUuidLongMember.class.isAssignableFrom(
              obj.getClass())) {
         TkRefexUuidUuidUuidLongMember another =
            (TkRefexUuidUuidUuidLongMember) obj;
   ...
   @Override
   public TkRefexUuidUuidUuidLongMember makeTransform(
           ComponentTransformerBI transformer) {
      return new TkRefexUuidUuidUuidLongMember(this, transformer);
   }
   ...
   public final void readExternal(DataInput in, int dataVersion)
      ...
      if (versionSize > 0) {
         ...
         for (int i = 0; i < versionSize; i++) {
            revisions.add(new TkRefexUuidUuidUuidLongRevision(in, dataVersion));
         }
      }
   }
   ...
   public void writeExternal(DataOutput out) throws IOException {
      ...
      if (revisions == null) {
         ...
         for (TkRefexUuidUuidUuidLongRevision rmv : revisions) {
   ...
   @Override
   public List<TkRefexUuidUuidUuidLongRevision> getRevisionList() {
      return revisions;
   }
