...
public abstract class Revision<V extends Revision<V, C>, C extends ConceptComponent<V, C>>
   ...
   public void setAuthorNid(int authorNid) {
      ...
      if (authorNid != getPathNid()) {
         this.stampNid = P.s.getStampNid(getStatusNid(), Long.MAX_VALUE, authorNid, getModuleNid(),
                                         getPathNid());
         modified();
      }
   }
   ...
   public final void setModuleNid(int moduleNid) {
      ...
      try {
         this.stampNid = P.s.getStampNid(getStatusNid(), Long.MAX_VALUE, getAuthorNid(), moduleNid,
                                         getPathNid());
      } catch (Exception e) {
   ...
   public final void setPathNid(int pathId) {
      ...
      this.stampNid = P.s.getStampNid(getStatusNid(), Long.MAX_VALUE, getAuthorNid(), getModuleNid(), pathId);
   }
   ...
   public final void setStatusNid(int statusNid) {
      ...
      try {
         this.stampNid = P.s.getStampNid(statusNid, Long.MAX_VALUE, getAuthorNid(), getModuleNid(),
                                         getPathNid());
      } catch (Exception e) {
         throw new RuntimeException();
      }
   ...
   public final void setTime(long time) {
      ...
      if (time != getTime()) {
         try {
            this.stampNid = P.s.getStampNid(getStatusNid(), time, getAuthorNid(), getModuleNid(),
                                            getPathNid());
         } catch (Exception e) {
            throw new RuntimeException();
         }
