...
public class TkRefexUuidUuidUuidIntRevision extends TtkRevision {
   ...
   public TkRefexUuidUuidUuidIntRevision() {
      super();
   }

   public TkRefexUuidUuidUuidIntRevision(RefexNidNidNidIntVersionBI another)
           throws IOException {
      super(another);
   ...
   public TkRefexUuidUuidUuidIntRevision(DataInput in, int dataVersion)
   ...
   public TkRefexUuidUuidUuidIntRevision(
           TkRefexUuidUuidUuidIntRevision another,
   ...
   public boolean equals(Object obj) {
      ...
      if (TkRefexUuidUuidUuidIntRevision.class.isAssignableFrom(
              obj.getClass())) {
         TkRefexUuidUuidUuidIntRevision another =
            (TkRefexUuidUuidUuidIntRevision) obj;
   ...
   @Override
   public TkRefexUuidUuidUuidIntRevision makeTransform(
           ComponentTransformerBI transformer) {
      return new TkRefexUuidUuidUuidIntRevision(this, transformer);
   }
