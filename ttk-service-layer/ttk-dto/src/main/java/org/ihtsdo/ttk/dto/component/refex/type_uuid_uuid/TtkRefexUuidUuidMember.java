package org.ihtsdo.ttk.dto.component.refex.type_uuid_uuid;
...
public class TtkRefexUuidUuidMember extends TtkRefexAbstractMember<TtkRefexUuidUuidRevision> {
   ...
   public TtkRefexUuidUuidMember() {
      super();
   }

   public TtkRefexUuidUuidMember(RefexChronicleBI another) throws IOException {
   ...
   public TtkRefexUuidUuidMember(DataInput in, int dataVersion) throws IOException, ClassNotFoundException {
      super();
      readExternal(in, dataVersion);
   }

   public TtkRefexUuidUuidMember(TtkRefexUuidUuidMember another, ComponentTransformerBI transformer) {
   ...
   public boolean equals(Object obj) {
      ...
      if (TtkRefexUuidUuidMember.class.isAssignableFrom(obj.getClass())) {
         TtkRefexUuidUuidMember another = (TtkRefexUuidUuidMember) obj;
   ...
   @Override
   public TtkRefexUuidUuidMember makeTransform(ComponentTransformerBI transformer) {
      return new TtkRefexUuidUuidMember(this, transformer);
   }
   ...
   public ToolkitRefexType getType() {
      return ToolkitRefexType.CID_CID;
   }
