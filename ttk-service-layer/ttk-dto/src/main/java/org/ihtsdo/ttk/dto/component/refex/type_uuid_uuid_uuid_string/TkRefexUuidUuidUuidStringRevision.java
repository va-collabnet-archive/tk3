...
public class TkRefexUuidUuidUuidStringRevision extends TtkRevision {
   ...
   public TkRefexUuidUuidUuidStringRevision() {
      super();
   }
   ...
   public TkRefexUuidUuidUuidStringRevision(DataInput in, int dataVersion)
   ...
   public TkRefexUuidUuidUuidStringRevision(
           TkRefexUuidUuidUuidStringRevision another,
   ...
   public boolean equals(Object obj) {
      ...
      if (TkRefexUuidUuidUuidStringRevision.class.isAssignableFrom(
              obj.getClass())) {
         TkRefexUuidUuidUuidStringRevision another =
            (TkRefexUuidUuidUuidStringRevision) obj;
   ...
   @Override
   public TkRefexUuidUuidUuidStringRevision makeTransform(
           ComponentTransformerBI transformer) {
      return new TkRefexUuidUuidUuidStringRevision(this, transformer);
   }
