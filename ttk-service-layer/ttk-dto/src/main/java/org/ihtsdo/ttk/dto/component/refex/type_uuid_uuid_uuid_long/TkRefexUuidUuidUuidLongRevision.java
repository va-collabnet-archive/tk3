...
public class TkRefexUuidUuidUuidLongRevision extends TtkRevision {
   ...
   public TkRefexUuidUuidUuidLongRevision() {
      super();
   }

   public TkRefexUuidUuidUuidLongRevision(RefexNidNidNidLongVersionBI another)
           throws IOException {
      super(another);
   ...
   public TkRefexUuidUuidUuidLongRevision(DataInput in, int dataVersion)
   ...
   public TkRefexUuidUuidUuidLongRevision(
           TkRefexUuidUuidUuidLongRevision another,
   ...
   public boolean equals(Object obj) {
      ...
      if (TkRefexUuidUuidUuidLongRevision.class.isAssignableFrom(
              obj.getClass())) {
         TkRefexUuidUuidUuidLongRevision another =
            (TkRefexUuidUuidUuidLongRevision) obj;
   ...
   @Override
   public TkRefexUuidUuidUuidLongRevision makeTransform(
           ComponentTransformerBI transformer) {
      return new TkRefexUuidUuidUuidLongRevision(this, transformer);
   }
