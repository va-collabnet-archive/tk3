package org.ihtsdo.ttk.dto.component.refex.type_uuid_int;
...
public class TtkRefexUuidIntMember extends TtkRefexAbstractMember<TtkRefexUuidIntRevision> {
   ...
   public TtkRefexUuidIntMember(RefexChronicleBI another) throws IOException {
   ...
   public TtkRefexUuidIntMember() {
      super();
   }

   public TtkRefexUuidIntMember(DataInput in, int dataVersion) throws IOException, ClassNotFoundException {
      super();
      readExternal(in, dataVersion);
   }

   public TtkRefexUuidIntMember(TtkRefexUuidIntMember another, ComponentTransformerBI transformer) {
   ...
   public boolean equals(Object obj) {
      ...
      if (TtkRefexUuidIntMember.class.isAssignableFrom(obj.getClass())) {
         TtkRefexUuidIntMember another = (TtkRefexUuidIntMember) obj;
   ...
   public TtkRevision makeTransform(ComponentTransformerBI transformer) {
      return new TtkRefexUuidIntMember(this, transformer);
   }
