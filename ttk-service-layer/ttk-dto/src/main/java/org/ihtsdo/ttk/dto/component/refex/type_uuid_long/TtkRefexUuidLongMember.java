...
public class TtkRefexUuidLongMember extends TtkRefexAbstractMember<TtkRefexUuidLongRevision> {
   ...
   //~--- constructors --------------------------------------------------------
   public TtkRefexUuidLongMember(RefexChronicleBI another) throws IOException {
   ...
   public TtkRefexUuidLongMember() {
      super();
   }

   public TtkRefexUuidLongMember(DataInput in, int dataVersion) throws IOException, ClassNotFoundException {
      super();
      readExternal(in, dataVersion);
   }

   public TtkRefexUuidLongMember(TtkRefexUuidLongMember another, ComponentTransformerBI transformer) {
   ...
   public boolean equals(Object obj) {
      ...
      if (TtkRefexUuidLongMember.class.isAssignableFrom(obj.getClass())) {
         TtkRefexUuidLongMember another = (TtkRefexUuidLongMember) obj;
   ...
   @Override
   public TtkRefexUuidLongMember makeTransform(ComponentTransformerBI transformer) {
      return new TtkRefexUuidLongMember(this, transformer);
   }
