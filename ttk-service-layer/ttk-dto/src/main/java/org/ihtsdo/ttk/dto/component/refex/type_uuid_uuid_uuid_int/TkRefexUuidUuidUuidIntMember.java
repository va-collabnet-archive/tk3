package org.ihtsdo.ttk.dto.component.refex.type_uuid_uuid_uuid_int;
...
public class TkRefexUuidUuidUuidIntMember
        extends TkRefexAbstractMember<TkRefexUuidUuidUuidIntRevision> {
   ...
   public TkRefexUuidUuidUuidIntMember() {
      super();
   }

   public TkRefexUuidUuidUuidIntMember(RefexChronicleBI another)
           throws IOException {
      ...
      if (partCount > 1) {
         ...
         while (relItr.hasNext()) {
            rv = relItr.next();
            revisions.add(new TkRefexUuidUuidUuidIntRevision(rv));
         }
      }
   }

   public TkRefexUuidUuidUuidIntMember(DataInput in, int dataVersion)
           throws IOException, ClassNotFoundException {
      super();
      readExternal(in, dataVersion);
   }

   public TkRefexUuidUuidUuidIntMember(TkRefexUuidUuidUuidIntMember another,
   ...
   public boolean equals(Object obj) {
      ...
      if (TkRefexUuidUuidUuidIntMember.class.isAssignableFrom(obj.getClass())) {
         TkRefexUuidUuidUuidIntMember another =
            (TkRefexUuidUuidUuidIntMember) obj;
   ...
   @Override
   public TkRefexUuidUuidUuidIntMember makeTransform(
           ComponentTransformerBI transformer) {
      return new TkRefexUuidUuidUuidIntMember(this, transformer);
   }
   ...
   public final void readExternal(DataInput in, int dataVersion)
      ...
      if (versionSize > 0) {
         ...
         for (int i = 0; i < versionSize; i++) {
            revisions.add(new TkRefexUuidUuidUuidIntRevision(in, dataVersion));
         }
      }
   }
   ...
   public void writeExternal(DataOutput out) throws IOException {
      ...
      if (revisions == null) {
         ...
         for (TkRefexUuidUuidUuidIntRevision rmv : revisions) {
   ...
   @Override
   public List<TkRefexUuidUuidUuidIntRevision> getRevisionList() {
      return revisions;
   }
