...
public class TkRefexUuidUuidUuidFloatRevision extends TtkRevision {
   ...
   public TkRefexUuidUuidUuidFloatRevision() {
      super();
   }

   public TkRefexUuidUuidUuidFloatRevision(RefexNidNidNidFloatVersionBI another)
           throws IOException {
      super(another);
   ...
   public TkRefexUuidUuidUuidFloatRevision(DataInput in, int dataVersion)
   ...
   public TkRefexUuidUuidUuidFloatRevision(
           TkRefexUuidUuidUuidFloatRevision another,
   ...
   public boolean equals(Object obj) {
      ...
      if (TkRefexUuidUuidUuidFloatRevision.class.isAssignableFrom(
              obj.getClass())) {
         TkRefexUuidUuidUuidFloatRevision another =
            (TkRefexUuidUuidUuidFloatRevision) obj;
   ...
   @Override
   public TkRefexUuidUuidUuidFloatRevision makeTransform(
           ComponentTransformerBI transformer) {
      return new TkRefexUuidUuidUuidFloatRevision(this, transformer);
   }
