...
public class TkRefexArrayOfByteArrayRevision extends TkRevision {
     ...
     */
    public TkRefexArrayOfByteArrayRevision(TkRefexArrayOfByteArrayRevision another, ComponentTransformerBI transformer) {
     ...
     */
    @Override
    public TkRefexArrayOfByteArrayRevision makeTransform(ComponentTransformerBI transformer) {
        return new TkRefexArrayOfByteArrayRevision(this, transformer);
    }
