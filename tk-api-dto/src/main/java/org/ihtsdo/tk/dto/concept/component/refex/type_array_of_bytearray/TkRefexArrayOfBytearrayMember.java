 ...
 * the License.
 */
package org.ihtsdo.tk.dto.concept.component.refex.type_array_of_bytearray;
...
public class TkRefexArrayOfByteArrayMember extends TkRefexAbstractMember<TkRefexArrayOfByteArrayRevision> {
     ...
     * @throws IOException signals that an I/O exception has occurred
     */
    public TkRefexArrayOfByteArrayMember(RefexArrayOfBytearrayVersionBI refexArrayOfBytearrayVersion) throws IOException {
     ...
     */
    public TkRefexArrayOfByteArrayMember(TkRefexArrayOfByteArrayMember another, ComponentTransformerBI transformer) {
     ...
     */
    @Override
    public TkRefexArrayOfByteArrayMember makeTransform(ComponentTransformerBI transformer) {
        return new TkRefexArrayOfByteArrayMember(this, transformer);
    }
