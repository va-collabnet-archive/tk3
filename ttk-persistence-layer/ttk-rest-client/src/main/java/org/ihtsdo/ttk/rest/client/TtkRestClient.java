...
public class TtkRestClient extends Termstore {
   ...
   private FxConceptChronicle getFxConcept(UUID conceptUUID, UUID vcUuid) {
      ...
      return response.readEntity(FxConceptChronicle.class, null);
   }
   ...
   @Override
   public int getStamp(org.ihtsdo.otf.tcc.api.Status status, long time, int authorNid, int moduleNid, int pathNid) {
      throw new UnsupportedOperationException("Not supported yet.");
   }
