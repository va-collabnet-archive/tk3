...
public class TkRefexUuidBooleanMember extends TkRefexAbstractMember<TkRefexUuidBooleanRevision> {
   ...
   public TkRefexUuidBooleanMember() {
      super();
   }

   public TkRefexUuidBooleanMember(RefexChronicleBI another) throws IOException {
      ...
      if (partCount > 1) {
         ...
         while (itr.hasNext()) {
            rv = itr.next();
            revisions.add(new TkRefexUuidBooleanRevision(rv));
         }
      }
   }

   public TkRefexUuidBooleanMember(DataInput in, int dataVersion) throws IOException, ClassNotFoundException {
      super();
      readExternal(in, dataVersion);
   }

   public TkRefexUuidBooleanMember(TkRefexUuidBooleanMember another, ComponentTransformerBI transformer) {
   ...
   public boolean equals(Object obj) {
      ...
      if (TkRefexUuidBooleanMember.class.isAssignableFrom(obj.getClass())) {
         TkRefexUuidBooleanMember another = (TkRefexUuidBooleanMember) obj;
   ...
   @Override
   public TkRefexUuidBooleanMember makeTransform(ComponentTransformerBI transformer) {
      return new TkRefexUuidBooleanMember(this, transformer);
   }
   ...
   public final void readExternal(DataInput in, int dataVersion) throws IOException, ClassNotFoundException {
      ...
      if (versionSize > 0) {
         ...
         for (int i = 0; i < versionSize; i++) {
            revisions.add(new TkRefexUuidBooleanRevision(in, dataVersion));
         }
      }
   }
   ...
   public void writeExternal(DataOutput out) throws IOException {
      ...
      if (revisions == null) {
         ...
         for (TkRefexUuidBooleanRevision rmv : revisions) {
   ...
   @Override
   public List<TkRefexUuidBooleanRevision> getRevisionList() {
      return revisions;
   }

   @Override
   public List<TkRefexUuidBooleanRevision> getRevisions() {
      return revisions;
   }
