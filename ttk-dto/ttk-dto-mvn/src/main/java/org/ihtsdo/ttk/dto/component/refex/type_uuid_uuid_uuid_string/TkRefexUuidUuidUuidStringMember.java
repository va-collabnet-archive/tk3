package org.ihtsdo.ttk.dto.component.refex.type_uuid_uuid_uuid_string;
...
public class TkRefexUuidUuidUuidStringMember
        extends TkRefexAbstractMember<TkRefexUuidUuidUuidStringRevision> {
   ...
   public TkRefexUuidUuidUuidStringMember() {
      super();
   }

   public TkRefexUuidUuidUuidStringMember(RefexChronicleBI another)
           throws IOException {
      ...
      if (partCount > 1) {
         ...
         while (relItr.hasNext()) {
            rv = relItr.next();
            revisions.add(new TkRefexUuidUuidUuidStringRevision(rv));
         }
      }
   }

   public TkRefexUuidUuidUuidStringMember(DataInput in, int dataVersion)
   ...
   public TkRefexUuidUuidUuidStringMember(
           TkRefexUuidUuidUuidStringMember another,
   ...
   public boolean equals(Object obj) {
      ...
      if (TkRefexUuidUuidUuidStringMember.class.isAssignableFrom(
              obj.getClass())) {
         TkRefexUuidUuidUuidStringMember another =
            (TkRefexUuidUuidUuidStringMember) obj;
   ...
   @Override
   public TkRefexUuidUuidUuidStringMember makeTransform(
           ComponentTransformerBI transformer) {
      return new TkRefexUuidUuidUuidStringMember(this, transformer);
   }
   ...
   public final void readExternal(DataInput in, int dataVersion)
      ...
      if (versionSize > 0) {
         ...
         for (int i = 0; i < versionSize; i++) {
            revisions.add(new TkRefexUuidUuidUuidStringRevision(in,
                    dataVersion));
         }
      }
   }
   ...
   public void writeExternal(DataOutput out) throws IOException {
      ...
      if (revisions == null) {
         ...
         for (TkRefexUuidUuidUuidStringRevision rmv : revisions) {
            rmv.writeExternal(out);
         }
      }
   }

   public List<TkRefexUuidUuidUuidStringRevision> getRevisionList() {
      return revisions;
   }
